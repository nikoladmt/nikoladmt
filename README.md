...
- 🔭 I’m a **Senior Software Engineer** who has strong experience in both **Mobile and Web** fields for over 10 years
- 🌱 I usually use **Kotlin Jetpack compose** to build Android application and **SwiftUI and UIKit** to build iOS applications as well as **Flutter and React Native** to build Cross platform applications.
- 👯 I’m also familiar with **React, Angular, Vue** to build the Frontend and **Python, Node** to build the backend it doesn't matter what the database concept is...
- 🥰 And I'm also in a strong experience with **Github, Jira, Clickup, AWS services, Firebase**💻💖
